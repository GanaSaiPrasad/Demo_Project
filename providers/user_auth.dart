...
class UserAuth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/$urlSegment?key=AIzaSyDMygEMcofbA1S_J2Nnz1pTFjse6s4lBkE';
    try {
  ...
  Future<bool> autoLogin() async {
    ...
    final expiryDate = DateTime.parse(extractedData['_expiryDate']);
  ...
  void _autoLogout() {
    ...
    _authTimer = Timer(Duration(minutes: timetoExpire), logout);
  }
}
